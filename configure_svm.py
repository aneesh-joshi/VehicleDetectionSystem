...
# vehicle_features = extract_color_features(vehicle_images, spatial_size=(spatial, spatial), hist_bins=histbin)
# non_vehicle_features = extract_color_features(non_vehicle_images, spatial_size=(spatial, spatial), hist_bins=histbin)
