...
def single_img_features(img, color_space='RGB', spatial_size=(32, 32),
    ...
    ctrans_tosearch = convert_color(img, conv='RGB2YUV')
    ...
    if hog_channel == 'ALL':
        ...
        features = get_hog_features(ctrans_tosearch[:,:,hog_channel], orient, pix_per_cell, cell_per_block, feature_vec=False).ravel()
...
def generate_search_windows(image):
