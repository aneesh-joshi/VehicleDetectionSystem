...
def single_img_features(img, color_space='RGB', spatial_size=(32, 32),
    ...
    vehicle_color_features = extract_color_features(['test_image.jpg'], spatial_size=(32, 32), hist_bins=5)

    vehicle_features = np.hstack((extract_hog_features(['test_image.jpg']), vehicle_color_features))
